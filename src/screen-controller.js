...
export default function ScreenControllerObject(DataManager) {
  ...
  function changeProjectDescription() {
    const projectDescriptionTextBox = document.querySelector(
      "#projectDescriptionText",
    );
    const projectDescriptionValue = document.querySelector(
      ".projectDescription",
    );
    ...
    projectDescriptionTextBox.addEventListener("keyup", (e) => {
      ...
      for (let p = 0; p < projectArray.length; p++) {
        if (projectArray[p].getProjectID() == projectID) {
          DataManager.changeProjectDescription(
            projectArray[p],
            projectDescriptionValue.dataset.replicatedValue,
          );
        }
      }
    });
  ...
  function changeProjectDueDate() {
    ...
    projectDueDatePicker.addEventListener("change", (e) => {
      ...
      for (let p = 0; p < projectArray.length; p++) {
        if (projectArray[p].getProjectID() == projectID) {
          DataManager.changeProjectDueDate(
            projectArray[p],
            new Date(projectDueDatePicker.value),
          );
  ...
  function changeProjectPriority() {
    ...
    projectPriorityDropdown.addEventListener("change", (e) => {
      ...
      for (let p = 0; p < projectArray.length; p++) {
        if (projectArray[p].getProjectID() == projectID) {
          DataManager.changeProjectPriority(
            projectArray[p],
            projectPriorityDropdown.value,
          );
  ...
  function changeTaskDescription() {
    const taskDescriptionTextBoxes = document.querySelectorAll(
      ".taskDescriptionText",
    );
        ...
        for (let p = 0; p < projectArray.length; p++) {
          ...
          for (let n = 0; n < projectTasks.length; n++) {
            if (projectTasks[n].getTaskID() == taskID) {
              DataManager.changeTaskDescription(
                projectTasks[n],
                taskDescriptionValues[n].dataset.replicatedValue,
              );
            }
          }
        }
    ...
    for (let i = 0; i < taskDueDatePickers.length; i++) {
      taskDueDatePickers[i].addEventListener("change", (e) => {
        ...
        for (let p = 0; p < projectArray.length; p++) {
          ...
          for (let n = 0; n < projectTasks.length; n++) {
            if (projectTasks[n].getTaskID() == taskID) {
              DataManager.changeTaskDueDate(
                projectTasks[n],
                new Date(taskDueDatePickers[i].value),
              );
    ...
    for (let d = 0; d < taskPriorityDropdowns.length; d++) {
      taskPriorityDropdowns[d].addEventListener("change", (e) => {
        ...
        for (let p = 0; p < projectArray.length; p++) {
          ...
          for (let n = 0; n < projectTasks.length; n++) {
            if (projectTasks[n].getTaskID() == taskID) {
              DataManager.changeTaskPriority(
                projectTasks[n],
                taskPriorityDropdowns[d].value,
              );
        ...
        for (let p = 0; p < projectArray.length; p++) {
          ...
          for (let n = 0; n < projectTasks.length; n++) {
            if (projectTasks[n].getTaskID() == ID) {
              ...
              drawEditProjectNameDiv(projectArray[p]);
  ...
  const clearTaskDueDateDiv = (task) => {
    const taskDueDateDiv = document.querySelector(
      `.taskDueDateDiv.${task.getTaskID()}`,
    );
    taskDueDateDiv.textContent = "";
  };

  const clearTaskPriorityDiv = (task) => {
    const taskPriorityDiv = document.querySelector(
      `.taskPriorityDiv.${task.getTaskID()}`,
    );
  ...
  const drawProjectDueDateDiv = () => {
    ...
    const projectDueDateDivExists =
      document.querySelector(".projectDueDateDiv");
  ...
  const drawProjectPriorityDiv = () => {
    const projectItemsDiv = document.querySelector(".projectItemsDiv");
    const projectPriorityDivExists = document.querySelector(
      ".projectPriorityDiv",
    );
  ...
  return { startAllListeners, drawHeader, drawSidebar, drawProject, drawTasks };
}
